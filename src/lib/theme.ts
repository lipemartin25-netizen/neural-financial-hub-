export const C = {
    ...
    bgAlt: 'var(--c-bg)',
    card: 'var(--c-card)',
    cardGrad: 'var(--c-card-grad)',
    cardHlGrad: 'var(--c-card-hl-grad)',
    secondary: 'var(--c-secondary, #181c22)',
    muted: 'var(--c-muted, #1e2228)',
    gold: '#c9a858',
    goldLight: '#dfc07a',
    goldDark: '#9a7d3a',
    ...
    textMuted2: 'var(--c-text-muted2)',
    border: 'var(--c-border)',
    borderGold: 'var(--c-border-gold)',
    borderGoldMed: 'var(--c-border-gold)',
